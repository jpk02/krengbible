...
**Matt 27 — Judas's death, Pilate/Barabbas, crucifixion mockery, cry of dereliction/torn veil, burial/guarded tomb**
- Judas's death + potter's field (27:1-10) — remorse (metamelomai) vs genuine repentance (2 Cor 7:10 godly vs worldly grief); deliberate contrast with Peter's parallel failure same chapter, divergent trajectories; combined Zechariah/Jeremiah citation reflects ancient naming-by-prominent-source convention, not an error
- Pilate/Barabbas trial (27:11-26) — Jesus's composed "you have said so" matches Caiaphas-oath directness; wife's dream-warning as unheeded outside witness; hand-washing as symbolic self-exoneration that cannot substitute for the real political power Pilate chooses not to exercise; "his blood be on us" — culpability belongs to specific human agents as fallen humanity broadly implicated, NOT one ethnicity collectively/perpetually (text doesn't support the antisemitic misreading with a long painful history)
- Crucifixion mockery (27:27-44) — Simon of Cyrene detail (Mark 15:21 naming his sons) suggests family later known to early church; gall-wine refusal = full undulled awareness matching Gethsemane's clear-eyed submission (cross-ref gall/vinegar Ps 69 anchor); "he saved others, himself he cannot save" as unintentionally exact statement of atonement's actual mechanism — mockers' logic inverted
- Cry of dereliction + torn veil (27:45-56) — darkness not a natural eclipse (Passover = full moon); "Eli Eli lema sabachthani" evokes Ps 22's WHOLE arc (abandonment→vindication), not isolated despair (cross-ref Ps 22 anchor, fuller treatment there); veil torn top-to-bottom = decisively God's act not man's, removing the barrier maintained since the tabernacle (cross-ref Numbers torn-veil anchor); Heb 9:8 states in doctrine what this states in event; resurrected saints timed to AFTER Christ's resurrection, preserving 1 Cor 15:20 firstfruits primacy; centurion's confession = first unambiguous human Son-of-God confession in Matthew, from an executioner not a disciple
- Burial + guarded tomb (27:57-66) — Joseph's costly risk echoes 26:6-13 anointing woman, bracketing the passion narrative with two uncalculating acts of devotion; Isa 53:9 "with a rich man in his death" fulfilled; women's presence as legally-uncredible-yet-first witnesses actually strengthens historical credibility; guard/seal meant as precaution becomes ironic evidence against the very stolen-body theory it was meant to prevent

**Matt 28 — Empty tomb/first witnesses, bribed guards, Great Commission (Matthew complete)**
- Empty tomb + first witnesses (28:1-10) — guards paralyzed like dead men vs women left standing, ironic role-reversal; angel's "do not be afraid" then substance pattern; women's legally-inadmissible testimony as first commissioned witnesses argues against invented-story theory (cross-ref 27:57-66 same point re: burial witnesses); "go tell my brothers" = reconciling family language despite 26:56 abandonment
- Bribed guards (28:11-15) — cover story self-refuting (sleeping witnesses can't testify to what happened while asleep); Rome's death penalty for dereliction explains the bribe's urgency; "spread among the Jews to this day" = Matthew naming a live contemporary controversy directly rather than avoiding it; guards' original honest report remains the most immediate eyewitness testimony in the Gospel
- Great Commission (28:16-20) — worship AND doubt coexisting refuses triumphalist cleanup; "all authority" as the hinge the commission rests on; 28:19 explicitly fulfills threads built since ch.1 (four women 1:1-17, magi 2:1-12, Galilee of Gentiles 4:15-16, centurion 8:10, Canaanite woman 15:21-28) — not isolated incidents but a named pattern; trinitarian formula stated plainly, pre-dating later doctrinal unpacking; "I am with you always" completes 1:23's Immanuel arc — name given before birth now spoken as living reality by the risen Christ in the Gospel's final words
...
**Mark 3 — Withered hand + anger detail, appointing the Twelve, Markan sandwich family/Beelzebul structure**
- Withered hand + growing hostility (3:1-12) — Sabbath-argument content anchored at Matt 12:1-14; UNIQUE TO MARK: "anger, grieved at hardness of heart" (3:5) as the only unambiguous statement of Jesus's anger in the Gospel (contrast disputed 1:41 variant); anger+grief aimed at the same target (calculated cruelty prioritizing a legal trap over available mercy); Pharisee+Herodian alliance (3:6) = first explicit murder plot, remarkably early (ch.3 of 16), same unlikely pairing recurs at 12:13-17
- Appointing the Twelve (3:13-19) — stated purpose sequence: "with him" BEFORE "sent out," relationship precedes mission; disciples' later repeated failures (4:38-40, 8:17-21, 9:18-19) tied to lapsed proximity; "Boanerges"/Sons of Thunder nickname UNIQUE TO MARK, fits later volatile-temperament episodes (10:35-41 cross-ref Matt 20:20-28, Luke 9:54); Judas flagged as betrayer even at this hopeful commissioning moment
- Markan sandwich: family/Beelzebul/family (3:20-35) — "he is out of his mind" (3:21) family reaction UNIQUE TO MARK, absent from Matthew entirely; Beelzebul-controversy content anchored at Matt 12:22-32, not repeated; names and explains Markan intercalation technique itself (cf. 11:12-25 fig tree/temple, 5:21-43 Jairus/hemorrhaging woman) — family's "out of his mind" and scribes' "possessed" as two versions of the same misidentification, structurally paired; 3:35's family-redefinition (content anchored at Matt 12:46-50) reads with heightened real-time weight given 3:21's setup that only Mark supplies

**Mark 4 — Sower/parable purpose, seed growing secretly (Mark-unique), storm calmed with Peter-eyewitness detail**
- Sower + purpose of parables (4:1-25) — sower/Isa 6:9-10/explanation content anchored at Matt 13:3-23, not repeated; Mark's "those around him with the twelve" (4:10) as slightly wider circle than Matthew specifies; lamp/measure sayings (4:21-25) read as commentary on the parable METHOD itself (temporary not permanent concealment), not a separate topic
- Seed growing secretly (4:26-29) — UNIQUE TO MARK, no parallel in Matthew or Luke; *automatē* ("of itself/automatic") emphasizes self-generating process over farmer's control; deliberate tonal contrast with ch.3's escalating urgency — patient, largely invisible growth not manufactured by striving; complements (not duplicates) mustard seed's MECHANISM-vs-SCALE distinction (mustard seed content anchored at Matt 13:31-32)
- Storm calmed (4:35-41) — sea-authority theology (Ps 89:9, 107:29) anchored at Matt 8:23-34, not repeated; Mark-unique physical details ("cushion," "other boats with him") fit Peter-eyewitness texture; disciples' sharper, accusatory "do you not care" (vs Matthew's more measured "Lord, save us") fits Mark's broader pattern of preserving disciples' failures unsmoothed (cross-ref 3:21 family alarm); closing question "who then is this" = the exact question the messianic secret has been building toward since ch.1's first exorcism

**Mark 5 — Gerasene demoniac's affliction, sent-to-testify reversal, Jairus/hemorrhaging woman with Mark-unique detail**
- Gerasene demoniac's condition + exorcism (5:1-13) — Mark's 20 verses vs Matthew's 7 (two demoniacs, terse); extended affliction description (chains broken, self-harm) unique to Mark's fuller telling; "Legion" = Roman military-unit term conveying overwhelming numerical possession; specific "about two thousand" pig count absent from Matthew; demons' self-destruction once released, not Jesus destroying pigs directly
- Sent to testify, not silenced (5:14-20) — reverses the messianic-secret pattern established since ch.1; healed man's "be with him" request echoes 3:14's stated purpose for the Twelve exactly, yet is refused; explicit commission to testify tracks likely geography/audience distinction (Jewish Galilee = concealment prudent against nationalist uprising risk; Gentile Decapolis = no such risk, testimony becomes gospel's reach into territory Jesus doesn't stay to evangelize directly); healed man = first recorded missionary to Gentile territory in this Gospel
- Jairus's daughter + hemorrhaging woman (5:21-43) — core theology (twelve years/twelve-year-old same-span-different-speed, contamination reversal, "daughter" address) anchored at Matt 9:18-26, not repeated; Mark's unique additions: woman's exhausting-all-resources backstory (5:26), disciples' incredulous pushback at "who touched me" (5:31), preserved Aramaic "Talitha cumi" (Peter-eyewitness texture), and the deliberately mundane closing instruction to feed the girl (5:43) — grounded attentiveness to physical need even after resurrection, matching 1:31's pattern

**Mark 6 — Nazareth rejection, Herod/John's death full narrative, feeding 5000 shepherd/order details, hardened-hearts ending**
- Nazareth rejection (6:1-6) — FRESH territory, not anchored elsewhere (Matthew's parallel 13:54-58 has no dedicated card); hometown crowd's biographical inventory used against him not for him; three concentric circles (hometown/relatives/household) trace increasing not decreasing intimacy as the actual barrier; "he marveled because of their unbelief" — only two things Jesus marvels at in the Gospels, exceptional faith (Matt 8:10 centurion) and exceptional absence of it, here
- Herod/John's death full narrative (6:14-29) — core theology (guilty conscience, regret≠repentance, foreshadows Pilate 27:24) anchored at Matt 14:1-12, not repeated; Mark's ~3x-longer telling supplies the domestic tension (Herod protecting a man he respects while married to a woman determined to kill him), the banquet/oath/daughter's-consultation-with-mother sequence in full narrative detail Matthew compresses away
- Feeding of 5000 (6:30-44) — core theology (four verbs anticipate Last Supper, twelve baskets, manna/banquet echoes) anchored at Matt 14:13-21, not repeated; "sheep without a shepherd" (Num 27:17/Ezek 34, cross-ref Matt 9:36 anchor) sharpened by proximity to the just-narrated false shepherd Herod; Mark-unique "green grass" (seasonal detail, cf. John 6:4 Passover timing) and structured hundreds/fifties seating (Ex 18:21 echo) — order imposed before the miracle, not spontaneous chaos
- Walking on water, hardened hearts (6:45-56) — Peter's-sinking/deity-confession content entirely absent from Mark's version (anchored in full at Matt 14:22-33); Mark's own ending replaces triumphant worship with "their hearts were hardened" (6:52) — same word (*pōroō*) as 3:5's Pharisee hardness, applied uncomfortably to the Twelve themselves (failure to connect evidence, not willful rejection); fits Mark's broader unflattering-disciples pattern (3:21, 4:38); closing Gennesaret healing summary (6:53-56) contrasts ordinary crowds' simple faith against the Twelve's own struggle to understand

**Mark 7 — Defilement/Gentile-audience editorial voice, Syrophoenician woman's messianic-secret framing, Ephphatha (Mark-unique)**
- Tradition/Corban/defilement (7:1-23) — core theology (Corban 5th-commandment evasion, Isa 29:13, defilement relocated to heart's output) anchored at Matt 15:1-20, not repeated; Mark's explanatory parenthetical on Jewish purity customs (7:3-4) and "thus he declared all foods clean" (7:19) editorial aside both suggest a Gentile-inclusive audience — a claim the early church later worked out painfully (Acts 10-11, Gal 2)
- Syrophoenician woman (7:24-30) — core theology ("dogs" as escalating test not contempt, second Gentile-faith-exceeds-Israel's episode) anchored at Matt 15:21-28, not repeated; "Syrophoenician" (contemporary Greco-Roman term) vs Matthew's "Canaanite" (older biblical-ethnic term) fits Mark's Gentile-audience orientation; "could not be hidden" (7:24) unique to Mark, continuing the messianic-secret failed-concealment pattern (1:34, 1:44-45, 3:12, 5:43)
- Ephphatha, deaf/mute man healed (7:31-37) — UNIQUE TO MARK, no parallel anywhere in Matthew/Luke/John; unusually elaborate tactile healing method (fingers in ears, spit, touch tongue) calibrated to the man's specific afflicted senses; preserved Aramaic "Ephphatha" matches 5:41 "Talitha cumi" pattern (Peter-eyewitness texture); Jesus's audible groan (*stenazō*, same word as Rom 8:22 creation's groaning) as visible emotional engagement, consistent with 3:5's anger/grief; messianic secret fails immediately again; crowd's verdict echoes Isa 35:5-6's messianic-age deaf/mute-reversal prophecy

**Mark 8 — Feeding 4000/hardened-hearts escalation, two-stage blind man (Mark-unique), Peter's confession minus commissioning language**
- Feeding 4000 + sign-seeking/leaven (8:1-21) — feeding/leaven content anchored at Matt 15:29-39 and Matt 16:1-12, not repeated; "sighed deeply" (8:12, *anastenazō*, intensified form of 7:34) before flat refusal of a sign; disciples' bread-forgetting failure draws the sharpest rebuke to the Twelve in the Gospel, directly echoing Isa 6:9-10's judicial-hardening language (cross-ref Matt 13:10-17) now aimed at insiders — direct escalation of 6:52
- Two-stage blind man at Bethsaida (8:22-26) — UNIQUE TO MARK, only two-attempt healing in any Gospel; widely read as a deliberate structural bridge to Peter's confession immediately following — real-but-incomplete sight as the exact pattern Peter's own confession-then-rebuke dramatizes one scene later; messianic secret continues (8:26)
- Peter's confession, passion prediction, cross-bearing (8:27-38) — core content (confession, first passion prediction, "get behind me Satan," cross-bearing) anchored at Matt 16:13-28, not repeated; Mark's version notably OMITS Matthew's entire "on this rock"/keys-of-the-kingdom commissioning block (16:17-19) — keeps scene's weight on the confession's content and cost rather than Peter's elevated status; "he said this plainly" (8:32) rules out ambiguous-communication reading of Peter's shock

**Mark 9 — Elijah-has-come conversation, I-believe-help-my-unbelief, ignored 2nd passion prediction, unauthorized exorcist+salt sayings**
- Transfiguration brief + Elijah-has-come conversation (9:1-13) — transfiguration content anchored at Matt 17:1-8, not repeated; Elijah-question dialogue (9:11-13) NOT anchored in Matthew's parallel — identifies John the Baptist as fulfillment already accomplished and rejected (cross-ref Matt 3 John-as-Elijah, Matt 11:14), ties John's suffering fate directly to the Son of Man's own coming passion
- Demon-possessed boy, "help my unbelief" (9:14-29) — core content anchored at Matt 17:14-20, not repeated; father's "I believe; help my unbelief" (9:24) entirely absent from Matthew's compressed version — faith and doubt held together, not disqualifying; disciples' failure diagnosed as prayer-dependence lapse (9:29) not technical gap, echoing 3:14's "with him" priority
- 2nd passion prediction ignored, who's greatest (9:30-37) — child-as-model content anchored at Matt 18:1-9, not repeated; Mark's own sequencing is the point: 2nd of THREE times a passion prediction is immediately followed by disciples' status-preoccupation (8:31-33, 9:30-34, 10:32-37 James/John); "afraid to ask" (9:32) = genuine incomprehension+fear, different failure mode than 8:32's outright rebuke
- Unauthorized exorcist + salt sayings (9:38-50) — 9:38-41 has no Matthew parallel at all; disciples' tribal gatekeeping instinct immediately follows and echoes the child-reception correction; millstone/hand-foot-eye content anchored at Matt 18:6-9, not repeated; closing salt sayings (9:49-50) entirely absent from Matthew — function as corrective to the chapter's own diagnosed pattern (status competition, gatekeeping)

**Mark 10 — Divorce w/o exception+children's indignation, Jesus loved him, walking-ahead image+Bartimaeus named**
- Divorce + children (10:1-16) — core divorce argument (Gen 1:27/2:24 vs Deut 24 concession) anchored at Matt 19:1-9, not repeated; Mark's version has NO exception clause (vs Matthew's sexual-immorality exception) and adds the wife-initiating-divorce case, noted honestly as an unresolved audience-context difference rather than harmonized away; "he was indignant" (10:14, *aganakteō*) at the children's rebuke — Mark-unique detail matching 3:5/1:41 anger pattern
- Rich young ruler (10:17-27) — core content (what-I-lack tell, camel/needle, human-impossible/God-possible) anchored at Matt 19:16-30, not repeated; "Jesus, looking at him, loved him" (10:21) entirely UNIQUE TO MARK — love placed immediately BEFORE the hardest demand, not softening or overridden by it; "children" (*teknon*) address to disciples afterward matches this tender register
- Third passion prediction + James/John + Bartimaeus (10:32-52) — ransom/servant-leadership content anchored at Matt 20:20-28, Bartimaeus healing content anchored at Matt 20:29-34, not repeated; "Jesus was walking ahead of them... amazed... afraid" (10:32) UNIQUE TO MARK, no equivalent visual/atmospheric detail in Matthew; third of three passion-prediction-met-with-status-seeking instances (cross-ref 8:31-33, 9:30-34); Mark alone NAMES the blind man (Bartimaeus son of Timaeus, vs Matthew's two anonymous men) and adds the cloak-throwing detail (10:50)

**Mark 11 — Fig tree/temple Markan sandwich structure, authority question's shorter ending**
- Fig tree brackets the temple cleansing (11:1-25) — triumphal entry/temple-cleansing/fig-tree-as-sign-act theology anchored at Matt 21:1-22, not repeated; Mark SPLITS cursing (day 1) and withering-discovery (day 3) across two mornings with the temple scene wedged between, vs Matthew's same-afternoon compression — explicit intercalation technique (cross-ref 3:20-35, 5:21-43 sandwiches), making the withered tree the interpretive key for the temple scene rather than an adjacent nature miracle; colt "no one has ever sat on" (11:2) and Jesus simply "looking around" before withdrawing (11:11) both Mark-specific; forgiveness-in-prayer addition (11:25) not in Matthew's parallel location
- Authority question, shorter ending (11:27-33) — trap-mirroring-trap content anchored at Matt 21:23-27, not repeated; Mark's version stops at Jesus's flat refusal with NO following parable of the two sons (Matt 21:28-32) — consistent with Mark's terser preference already seen omitting Matt 16:17-19's Peter material; standoff itself left standing as the scene's whole point

**Mark 12 — Five-controversies compression, widow's mite (Mark/Luke-unique)**
...
**Mark 14 — Abba+Simon naming, naked young man fleeing (Mark-unique mystery), "I am" vs Matthew's indirect answer**
- Anointing/Judas, Last Supper, Gethsemane (14:1-42) — core content anchored at Matt 26:1-46, not repeated; "pure nard... 300 denarii" (14:3,5) more specific than Matthew's general phrasing, matches John 12:5 independently; preserved Aramaic "Abba" (14:36) matches 5:41/7:34 pattern, later quoted untranslated by Paul (Rom 8:15, Gal 4:6); Jesus addresses Peter as "Simon" not "Peter" at the exact moment of his watch-failure (14:37) — his pre-calling name at the moment he fails the role that name change was for
...
**Luke 2 — Census/manger, shepherds as first witnesses, Simeon's Nunc Dimittis + sword prophecy/Anna, boy Jesus in the temple**
- Census, birth, manger (2:1-7) — Roman decree unknowingly fulfills Micah 5:2 (Bethlehem); *kataluma* ("guest room," same word as Last Supper's 22:11) vs *pandocheion* ("inn," Good Samaritan's 10:34) — likely a full family home, not a cruel innkeeper turning them away; manger detail's plainness carries the humility, no villain required
- Shepherds as first witnesses (2:8-20) — low-status, ritually-suspect trade, testimony not always trusted in court; first full example of the humble-exalted reversal already signaled in the Magnificat (1:52); angelic sign deliberately unimpressive (swaddling cloths, manger); shepherds become first evangelists — same "unlikely witness" logic the empty-tomb women will carry later (24:1-11)
- Simeon + Anna (2:21-38) — circumcision/purification/turtledoves (Lev 12, Lev 5:7 poverty concession) discharged plainly; Nunc Dimittis (2:29-32) sounds Luke's Gentile-inclusion keynote this early, distinct from but harmonizing with Matthew's Magi (anchored Matt 2); Simeon's sword-prophecy to Mary alone (2:34-35) is the infancy narrative's first explicit shadow of the cross; Anna as paired female witness alongside Simeon, continuing ch.1's Zechariah/Mary paired-song pattern
- Boy Jesus in the temple (2:41-52) — only canonical childhood episode; "listening and asking," not instructing (contrast later apocryphal exaggeration); "I must be in my Father's house" (2:49) is Jesus's first recorded words in this Gospel and the first appearance of *dei* ("must," divine necessity), a marker Luke-Acts reuses throughout (9:22, 17:25, 24:7, 24:26, 24:44, Acts 1:16); "they did not understand" — even Mary, already twice informed (1:26-38, 2:34-35), doesn't yet grasp the full shape; closes on ordinary submission and balanced growth (2:51-52)

**Luke 3 — Six-fold historical dating + "what shall we do" ethics, baptism's added prayer detail, genealogy backward to Adam**
- John's ministry (3:1-20) — six-fold secular synchronism (3:1-2) matches the census's historian's-instinct (2:1-2); core preaching content (brood of vipers, axe at the root, Isa 40) anchored at Matt 3, not repeated; Luke-unique: crowds/tax collectors/soldiers each ask "what shall we do" (3:10-14) — repentance cashed out in vocation-specific ethics (share surplus, collect no more than assessed, no extortion/be content), not a change of station; template recurs at Zacchaeus (ch.19); Herod's imprisonment of John (3:19-20) placed out of chronological order to close John's arc before the spotlight shifts fully to Jesus
- Baptism (3:21-22) — brief; core Trinitarian content (voice/water/Spirit, Ps 2:7 + Isa 42:1 fusion) anchored at Matt 3; Luke-unique added detail: "was praying" when heaven opened — first instance of this Gospel's sustained prayer motif (recurs 6:12, 9:18, 9:28-29 transfiguration, 11:1, 22:44 Gethsemane)
- Genealogy backward to Adam (3:23-38) — contrasts Matthew's forward Abraham-to-Jesus, 3x14 structure (anchored Matt 1); best-attested explanation: Matthew traces Joseph's legal/royal line, Luke likely traces Mary's own line (fitting Luke's Mary-perspective access elsewhere); both converge on David via different sons, strengthening rather than weakening the claim; theological point is Luke's own — going past Abraham to "Adam, son of God" grounds Jesus's humanity in the whole race, not Israel's covenant history alone, matching Simeon's Gentile-light keynote (2:32); "son of God" closing phrase sets up implicit Adam/Christ contrast the wilderness temptation (ch.4) makes explicit

**Luke 4 — Temptation's Spirit-bracket + kairos warning, Nazareth sermon/rejection (programmatic), Capernaum's "sent for this purpose"**
- Temptation (4:1-13) — three-temptation content/Deuteronomy typology anchored at Matt 4, not repeated; order of 2nd/3rd temptations transposed, minor and not load-bearing; Luke-unique: "full of the Holy Spirit"/"power of the Spirit" inclusio (4:1, 4:14) fits this Gospel's pneumatology; closing "until an opportune time" (*kairos*, 4:13) is picked back up explicitly at 22:3 ("Satan entered into Judas") — Luke alone bookends the whole public ministry with named satanic opposition at both ends
- Nazareth sermon/rejection (4:14-30) — Luke's own programmatic mission statement (parallel role to Matthew's Sermon on the Mount); Isa 61:1-2 read and stopped before "day of vengeance"; "today this Scripture has been fulfilled" as direct self-claim; Elijah/widow of Zarephath + Elisha/Naaman precedents (both Gentile) predict both his own rejection at home and the coming Gentile mission, continuing 2:32/3:38's universal keynote; crowd's turn from admiration to attempted cliff-murder is the Gospel's first and most vivid instance of the "own people most resistant" pattern
- Capernaum ministry (4:31-44) — synagogue exorcism/Simon's mother-in-law/sundown healings/dawn withdrawal-to-pray content anchored at Mark 1, not repeated; Luke-unique close: crowds (not just disciples) try to keep him from leaving; "I must preach... for I was sent for this purpose" (4:43) reuses *dei* from 2:49, first application of the divine-necessity marker to the shape of the itinerant ministry itself, read against the sermon just given/rejected

**Luke 5 — Miraculous catch + Peter's confession (Luke's own fuller call story), physician's-eye leper/paralytic healings, "the old is good" saying (Luke-unique)**
- Miraculous catch + call (5:1-11) — FRESH/Luke-unique in full, fills in what Matthew's abrupt "immediately left nets" (anchored Matt 4) assumes; "at your word" obedience despite professional confidence; Simon's "depart from me, I am a sinful man" mirrors Isa 6:5 — proximity to holiness, not distance, produces acute self-awareness of sin; "catching men" repurposes rather than discards Simon's actual trade
- Leper + paralytic (5:12-26) — core content (touch-the-untouchable boundary-crossing, healing-as-evidence-for-forgiveness argument) anchored at Mark 1 / Matt 9, not repeated; Luke's physician's-eye precision (consistent with Col 4:14 tradition): "full of leprosy" (advanced stage, not softened), "immediately the leprosy left him" (clinical departure language), roof opened by removing tiles specifically (Palestinian construction detail) — same historian's precision already seen at 2:1-2, 3:1-2
- Levi's call/feast/wineskins (5:27-39) — core content (Hos 6:6, wineskins-as-new-capacity argument) anchored at Matt 9, not repeated; Luke-unique closing line, absent from Matthew/Mark: "no one after drinking old wine desires new... the old is good" (5:39) — not Jesus conceding the point but a wry observation on why the gospel's newness keeps meeting resistance, quietly explaining (without excusing) the Nazareth crowd's (4:16-30) and this chapter's Pharisees' pattern

**Luke 6 — Sabbath controversies + all-night prayer before the Twelve, Sermon on the Plain's blessings/woes pairing, "be merciful" vs Matthew's "be perfect"**
- Sabbath controversies + choosing the Twelve (6:1-11, 12-16) — grain-picking/withered-hand content anchored at Matt 12:1-14, not repeated; Pharisees' accusation-seeking motive named plainly (6:7); Luke-unique: "all night he continued in prayer to God" (6:12) precedes naming the Twelve — not in Mark's parallel (anchored Mark 3) — continuing the baptism/wilderness prayer pattern (3:21, 4:1), weightiest decisions get the most deliberate withdrawal
- Sermon on the Plain: blessings + woes (6:17-26) — set on a "level place," crowd includes Tyre/Sidon (Gentile-adjacent, continuing 2:32/4:25-27's reach); Beatitudes' spiritualized content ("poor in spirit" etc.) anchored at Matt 5; Luke-unique: unqualified "blessed are you who are poor" paired with four matching woes (rich/full/laughing/well-spoken-of, 6:24-26), absent from Matthew — sharpens the Magnificat's social-reversal theme (1:53) rather than softening it; woes target complacent self-sufficiency, not wealth itself (cf. Zacchaeus, ch.19)
- Love enemies/golden rule/judging/tree-fruit/builders (6:27-49) — core content anchored at Matt 5-7, not repeated; one notable substitution: Luke's capstone is "be merciful, even as your Father is merciful" (6:36) where Matthew has "be perfect" (5:48, already anchored) — mercy, not abstract perfection, is Luke's recurring divine attribute (Benedictus 1:72/1:78, prodigal's father 15:20, tax collector's plea 18:13); paired with 6:35's more transactional "lend, expecting nothing in return," fits Luke's pattern of pushing ethics toward tangible practice (cf. John the Baptist's instructions, 3:10-14)

**Luke 7 — Widow of Nain's unprompted resurrection, tax-collectors-vs-Pharisees aside, sinful woman/two debtors** (authored earlier this session; see cards)
- Centurion's servant + widow of Nain (7:1-17) — centurion content anchored at Matt 8; widow of Nain FRESH/Luke-unique — only unprompted resurrection in the Gospels, pure *splangchnizomai* compassion requiring nothing (not even faith), echoes Elijah/Zarephath (1 Kgs 17:23) previewed in Nazareth sermon (4:25-26)
- John's prison question (7:18-35) — core content anchored at Matt 11; Luke-unique aside (7:29-30): tax collectors accepted John's baptism, Pharisees/lawyers "rejected God's purpose for themselves," reframing the children's-game complaint as an already-demonstrated split
- Sinful woman anoints Jesus / two debtors (7:36-50) — Luke-unique (distinct from Bethany anointing); forgiveness PRECEDES and produces love (parable runs opposite to merit reading); Simon's correct doctrine masks no felt sense of his own debt

**Luke 8 — Women who bankrolled the mission, hearing-and-doing cluster, "where is your faith?"/Gerasene, physician's-eye Jairus/hemorrhaging woman (now on Opus)**
- Women patrons (8:1-3) — Luke-unique; Mary Magdalene (seven demons), Joanna (wife of Herod's steward Chuza), Susanna fund the itinerant mission "out of their means" — socially scandalous mixed band; same named women return as first resurrection witnesses (24:10), so their patronage is load-bearing not decorative
- Sower + lamp + true family (8:4-21) — core content anchored at Matt 13:3-23 / Mark 4:21-25 / Matt 12:46-50, not repeated; Luke's arrangement is the interpretation: "seed is the word of God" stated directly (8:11), whole section revolves around hearing ("take care how you hear," 8:18), and true-family scene deliberately relocated to the END (8:21, "hear the word of God and do it") so it becomes the living illustration of the sower's good soil — good soil has a name and face: kinship with Christ
- Storm + Gerasene demoniac (8:22-39) — sea-authority/Legion content anchored at Matt 8:23-34 / Mark 5:1-20; Luke-unique wording: "where is your faith?" (8:25, locates failure in displaced faith, diagnostic not just rebuke); "clothed and in his right mind" at Jesus's feet (8:35, portrait of what deliverance produces); "declare how much God has done" → man proclaims "how much Jesus had done" (8:39) — Luke lets the God/Jesus identification sit unremarked (same move as 2:32 keynote pattern); first Gentile commissioned to broadcast across a whole city
- Jairus's daughter + hemorrhaging woman (8:40-56) — core (twelve-years/twelve-year-old, contamination reversal, "daughter") anchored at Matt 9:18-26; physician's-eye additions (Col 4:14 tradition, same as Luke 5): "could not be healed by anyone" (8:43, softens Mark's physician-indictment, keeps incurability), "power has gone out from me" (8:46, healing as registered power-transfer), "her spirit returned" (8:55, distinctly Lukan death=spirit-departs/resurrection=spirit-returns anthropology), closing "give her something to eat" (grounded bodily attentiveness even after resurrection, matches 4:39 / Mark 5:43 pattern)

**Luke 9 — Prayer-framed confession + "daily" cross, Transfiguration's exodus, "set his face" to Jerusalem (travel narrative begins), cost of following/the plow (the Gospel's hinge chapter; now on Opus)**
- 9:1-17 (sending the Twelve, Herod's perplexity, feeding the 5000) — all anchored at Matt 10/14 & Mark 6, not re-carded; cards focus on the Luke-distinctive back half
- Peter's confession + first passion prediction + cross-bearing (9:18-27) — core anchored at Matt 16:13-28 / Mark 8, not repeated; Luke-unique frame: confession located in prayer ("as he was praying alone," 9:18, 4th hinge-prayer after 3:21/6:12) not geography; "daily" added to "take up his cross" (9:23) — relocates the cross from the martyr's one great sacrifice into ordinary repeated dying-to-self
- Transfiguration (9:28-36) — core (face, clothes, Moses/Elijah, cloud, voice) anchored at Matt 17:1-8 / Mark 9; Luke-unique: "eight days," transfigured "as he was praying" (glory emerges from prayer); Moses/Elijah "spoke of his departure" = *exodos*, "which he was about to accomplish at Jerusalem" (9:31) — the cross named as an exodus/deliverance-through-death, what the glory is FOR; disciples "heavy with sleep" (9:32) prefigures Gethsemane's sleep (22:45), same men can't stay awake on both mountains
- "Set his face to go to Jerusalem" + Samaritan rejection (9:51-56) — LUKE-UNIQUE and the structural pivot: opens the great travel narrative (9:51–19:27, longest section, holds Good Samaritan/prodigal/Zacchaeus/most parables); "set his face" echoes prophetic resolve (Isa 50:7 flint); James/John want Elijah's fire from heaven (2 Kgs 1:10-12, Elijah just appeared at 9:31) but Jesus rebukes them — mantle passed to one who absorbs rejection not incinerates it; Acts 8's Samaritan town later receives the gospel (the fire would have consumed the future harvest)
- Cost of following / the plow (9:57-62) — first two exchanges (foxes/nowhere-to-lay-head, "let the dead bury their dead") anchored at Matt 8:18-22; third is Luke-unique and saved for last: would-be follower wants to say farewell first (echoes Elisha's granted goodbye, 1 Kgs 19:20) but "no one who puts his hand to the plow and looks back is fit for the kingdom" (9:62) — a plowman looking back can't cut a straight furrow; the greater call denies even the backward glance Elijah allowed; placed at the chapter's end, the demand on followers mirrors the demand Jesus just made of himself (9:51)

**Luke 10 — Seventy-two sent + Satan's fall, rejoicing in the Spirit, Good Samaritan, Martha and Mary (heavily Luke-unique; on Opus)**
- The seventy-two (10:1-20) — LUKE-UNIQUE (distinct from the Twelve's sending, anchored Matt 10); wider-than-the-Twelve mission fits Luke's whole arc; number 70/72 textually uncertain, echoes Num 11 elders + Gen 10 nations (gestures beyond the tribes to the world); harvest plentiful/laborers few, lambs among wolves, "kingdom of God has come near" said to both receivers AND rejecters; return "I saw Satan fall like lightning" (10:18) — the small mission as visible edge of a cosmic collapse; corrective (10:20): rejoice not that spirits submit but that your names are written in heaven (the safer joy no failure can touch)
- Rejoicing in the Spirit / hidden from the wise (10:21-24) — woes (10:13-16) anchored Matt 11:20-24; Father-Son mutual knowing + "hidden from wise, revealed to little children" anchored Matt 11:25-27; Luke-unique frame: "rejoiced in the Holy Spirit" (10:21) — rare glimpse of Jesus rejoicing, explicitly Trinitarian (Son in the Spirit exulting to the Father), triggered by the 72's return; the wise-excluded/infants-included reversal is the same pattern as shepherds/scholars (2:8-20), tax-collectors/Pharisees (7:29-30), poor/rich (6:20-26); disciples see what "prophets and kings desired to see... and did not" (10:24)
- Good Samaritan (10:25-37) — LUKE-UNIQUE; lawyer's "who is my neighbor" assumes a line to draw; priest + Levite (the law's professionals) pass by, a Samaritan is the only neighbor — the least-expected/most-resented hero, sharpened by ch.9's Samaritan-village rejection the disciples wanted to burn (9:51-56); Jesus reverses the question ("who is my neighbor" → "which one BECAME a neighbor," 10:36) — neighbor isn't a category to identify but something you become to whoever's in front of you; lawyer can't say "Samaritan" ("the one who showed mercy"); "go and do likewise" erases the line rather than locating it
- Martha and Mary (10:38-42) — LUKE-UNIQUE; NOT a simple contemplation-beats-action contest; Mary "at the Lord's feet" = disciple's posture a woman wasn't expected to take, and Jesus lets her keep it; rebuke falls on the anxiety ("anxious and troubled," 10:41) not the serving — work crowded out the one thing it should have made room for (attention to Jesus); doubled name "Martha, Martha" = gentle gravity; placed right after the Samaritan's "go and do," it deliberately guards against reducing discipleship to doing — the going must flow from the listening; "the good portion" = choosing, amid many good pressing things, the one that can't be taken away

**Luke 11 — Teach us to pray (Lord's Prayer/friend at midnight/the Spirit), the finger of God, sign of Jonah/something greater, woes at the dinner table (on Opus)**
- Teaching on prayer (11:1-13) — prompted by watching Jesus pray ("Lord, teach us to pray," 11:1, the prayer motif again); Luke's Lord's Prayer is a shorter/distilled form of Matthew's (anchored Matt 6:9-13); Luke-unique friend-at-midnight parable (11:5-8) = lesser-to-greater argument from persistence (not God worn down); ask/seek/knock anchored Matt 7:7-11 BUT Luke's climax differs tellingly — the Father gives "the Holy Spirit to those who ask" (11:13) where Matthew has "good things" (Matt 7:11): the answer to prayer named as God giving himself
- The finger of God (11:14-28) — Beelzebul controversy + divided-kingdom + returning-unclean-spirit anchored Matt 12:22-30/43-45 & Mark 3; Luke-unique phrase: "finger of God" (11:20, Greek literally *finger*; NKRV renders "손") vs Matthew's "Spirit of God" — echoes Ex 8:19 (Pharaoh's magicians' confession), framing exorcisms as a new-Exodus confrontation, kingdom measured in captives freed; Luke-unique capstone (11:27-28): woman blesses Jesus's mother's womb, Jesus redirects — "blessed rather are those who hear the word of God and keep it" (same move as 8:21; Mary's truest blessedness is hearing+treasuring, 1:38/2:19, opened to all)
- Sign of Jonah / something greater (11:29-36) — core (Jonah/resurrection, Nineveh + Queen of South, proportional accountability) anchored Matt 12:38-42; Luke's emphasis: Jonah HIMSELF "became a sign" (11:30, the preacher from afar); "something greater than Jonah/Solomon is here" — pagans with a fraction of the light responded, insiders before the reality demand proof; light/eye sayings (11:33-36, anchored Matt 5:15/6:22-23) turn sign-seeking back on the seeker: not a lighting problem (light blazes) but a seeing problem, no sign heals an eye that won't see
- Woes at the dinner table (11:37-54) — Jesus skips ritual handwashing at a Pharisee's meal; woes overlap Matt 23 but Luke keeps them AT the table, aimed at the men sharing his food; Pharisees clean the cup's outside / full of greed inside, tithe mint+rue but neglect "justice and the love of God" (11:42); lawyers load unbearable burdens they won't touch, build the tombs of prophets their fathers killed (11:47-48), "have taken away the key of knowledge" (11:52); severity is because of their insider status not despite it — law turned into a barrier; ends with leaders "lying in wait for him" (11:53-54): the kingdom-preacher is now hunted

**Luke 12 — Rich fool, fear not little flock / sell your possessions, the master who serves / much given, fire and a baptism (on Opus)**
- The rich fool (12:13-21) — LUKE-UNIQUE; inheritance-dispute request refused, covetousness named ("life does not consist in the abundance of possessions," 12:15); the parable's real folly shown by its form — a man talking only to himself ("I/my" a dozen times, no God, no neighbor, the poor never cross his mind); "this night your soul is required of you" (12:20) — built security on a timescale he didn't control, treated life as owned not loaned; "rich toward God" (12:21) = open hands, rich toward the neighbor he never considered
- Fear not, little flock (12:22-34) — anti-anxiety (ravens/lilies/seek-the-kingdom) anchored Matt 6:25-33; Luke-unique tenderness: "Fear not, little flock, for it is your Father's good pleasure to give you the kingdom" (12:32) — antidote to fear is the Father's pleasure not the flock's size; then Luke presses past Matthew into action: "sell your possessions, give to the needy" (12:33) — freedom from anxiety frees the hand to give; the rich fool's opposite (possessions → treasure in heaven by giving away); "where your treasure is, there your heart" (12:34)
- The master who serves / much given (12:35-48) — watchful-servant/thief/faithful-manager content anchored Matt 24:42-51; Luke-unique startling image: the returning master "will dress himself for service... and serve them" (12:37) — the one with every right to be waited on waits on those who waited for him (kingdom inversion, foreshadows 22:27 upper room); Luke states accountability more sharply — servant who KNEW gets a severe beating, who didn't a light one; "to whom much was given, much required" (12:48): revelation raises the stakes, the disciples are made responsible not safe
- Fire and a baptism (12:49-53) — largely Luke-unique, most emotionally exposed words in the Gospel: "I came to cast fire... I have a baptism to be baptized with, and how great is my distress until it is accomplished!" (12:49-50); "baptism" = his death (cf. the exodus of 9:31), confessing constrained/impatient anguish; the fire (dividing judgment) can't be kindled until the baptism is undergone — the cross is the condition of everything; "not peace but division" (12:51, echoing Micah 7:6) is the cost, not contradiction, of the angels' "peace on earth" (2:14) — real peace with God bought through fire and baptism, running like a fault line through every unbending allegiance

**Luke 13 — Repent or perish / barren fig tree, the bent woman loosed on the Sabbath, the narrow door, that fox / lament over Jerusalem (on Opus)**
- Repent or perish + barren fig tree (13:1-9) — refuses the suffering-maps-to-guilt assumption (Galileans under Pilate, the 18 under Siloam's tower "not worse sinners"); turns "why them?" into "unless you repent, you will all likewise perish" (13:3,5) — death universal, the deflecting instinct to explain another's tragedy avoids one's own repentance; fig tree "let it alone this year also... but if not" (13:8-9): mercy delays judgment for fruit, but the delay is finite (cf. Rom 2:4)
- The bent woman loosed on the Sabbath (13:10-17) — 18-yr "disabling spirit," bent double; Jesus frames it as Satan's binding, healing as loosing; ruler's Sabbath-work objection answered lesser-to-greater ("you untie your ox to water it — ought not this daughter of Abraham be loosed?" 13:15-16); the Sabbath (release, Deut 5:15; true rest Matt 11:28 / Heb 4) is the FITTEST day for liberation, not the wrong one — true Sabbath work = undoing Satan's work
- The narrow door (13:22-30) — "will those saved be few?" refused as a head-count, turned into "strive to enter" (13:24); shut door, "Lord open to us" / "I do not know where you come from" (13:25); "we ate and drank with you, you taught in our streets" (13:26) = proximity, not belonging — nearness/association ≠ entry (repentance + faith do); Luke's reversal: covenant-born cast out, people from east/west/north/south recline (13:28-29); last-first / first-last (13:30) — closed to the presumptuous, not the far-off
- That fox / lament over Jerusalem (13:31-35) — Pharisees warn of Herod; "go tell that fox... today and tomorrow, the third day I finish my course" (13:32): cunning-but-small, no power over the mission's timeline; "a prophet cannot perish away from Jerusalem" (13:33) — walking open-eyed toward the prophet-killing city; lament "O Jerusalem, Jerusalem" is a cry, not cold indictment; tenderest self-image: mother hen gathering chicks "and you were not willing" (13:34) — obstacle is their refusal, not God's reluctance; grief + defiance are one motion (resolute because he loves it enough to die there — the death IS the shelter they refused); "house forsaken... until you say 'Blessed is he who comes'" (13:35, Ps 118:26) — judgment shaded by hope, the "until" leaves a door ajar
