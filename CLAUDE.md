...
- Luke: **in progress (1-4 done, 5-24 remain)**.  Same cross-referencing discipline as Mark — Luke's cards take Luke's own distinctive angle (historian's preface, attention to women/poor/outsiders, Magnificat/Benedictus, travel-narrative material unique to Luke) rather than re-explaining Matthew/Mark-anchored content.
- John remains.
