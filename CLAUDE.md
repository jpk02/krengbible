...
- Luke: **in progress (1-12 done, 13-24 remain)**.  Luke 8+ authored on Opus (elevated quality); 1-7 on Sonnet.  Plan: finish Luke+John on Opus, then re-run all earlier (Sonnet-authored) chapters on Opus in a second pass.  Same cross-referencing discipline as Mark — Luke's cards take Luke's own distinctive angle (historian's preface, attention to women/poor/outsiders, Magnificat/Benedictus, travel-narrative material unique to Luke) rather than re-explaining Matthew/Mark-anchored content.
- John remains.
